...
![Silver Fox Full Attack Chain](flowchart_en.png)
...
> See Key Statistics above: HK$200M loss from a single Deepfake + MitB combined attack.

#### 3. AI-Powered Full Chain — Entering the "AI vs. AI" Era

> See Trend #2 above for the full breakdown. The most impactful case: LLM-generated spear-phishing + Deepfake executive video call → HK$200M fraud against a Hong Kong multinational, bypassing traditional "call-back verification" defenses entirely.
